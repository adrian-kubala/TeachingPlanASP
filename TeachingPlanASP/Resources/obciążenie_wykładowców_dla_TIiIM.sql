SELECT Specjalnosc.Nazwa_specjalnosci, Nauczyciel.Imie_nauczyciela, Nauczyciel.Nazwisko_nauczyciela, 
...
WHERE Rodzaj_zajec.Id_rodzaju_zajec = Przedmiot.Id_rodzaju_zajec AND
	...
	[PRZEDMIOT-NAUCZYCIEL].Id_nauczyciela = Nauczyciel.Id_nauczyciela
